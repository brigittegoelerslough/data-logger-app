...
export default function Dropdown() {
    ...
    return (
        <ul className="text-sm md:text-base flex space-x-3 md:space-x-6 justify-center items-center">
            <li>
                <a href="/" className="text-white hover:text-blue-500 mr-3" onMouseOver={closeDropdown}>
                    Home
                </a>
            </li>
            
            <li>
                <a href="/log-data" className="text-white hover:text-blue-500" onMouseOver={closeDropdown}>
                    Log Data
                </a>
            </li>
