  ...
  return (
    <div className="lg:flex">
      <div className="lg:flex-shrink-0 lg:flex-grow basis-1/4 pt-0 object-center lg:my-auto ">
        ...
        <select
          className="max-w-64 h-10 m-auto text-black col-span-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
          ref={timeRef}
          onChange={async () => {
