  ...
  return (
    <div className="">
      ...
      <form className="max-w-sm py-6 items-start">
        <label className="text-left ml-1 block mb-1 text-lg font-small text-white">
          {" "}
          Amount:{" "}
        </label>
        <select
          ...
          id="ammt"
          name="ammt"
          className="mx-auto w-72 lg:w-full h-12 bg-gray-50 border border-gray-300 text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block  p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
        >
          <option value=""></option>
          <option value="1">1</option>
          <option value="2">2</option>
        ...
        <label className="text-left ml-1 block mb-1 mt-4 text-lg font-small text-white justify-start">
          {" "}
          Time:{" "}
        </label>
        <input
        ...
        <label className="text-left ml-1 block mb-1 mt-4 text-lg font-small text-white">
          {" "}
          Date:{" "}
        </label>
        <input
