       ...
       <div className="">
        ...
        <form className="max-w-sm py-6 items-start">
            ...
            <input 
                ...
                className="mx-auto w-72 lg:w-full h-12 items-center justify-center bg-gray-50 border border-gray-300 text-gray-900 rounded-md focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                />
