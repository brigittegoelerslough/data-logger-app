   ...
   return (
       <div className="">
        ...
        <form className="max-w-sm py-6 items-start">
            ...
            id="ammt" 
            name="ammt" 
            className="sm:block md:flex justify-items-center text-center md:text-left mx-auto w-72 lg:w-full h-12 bg-gray-50 border border-gray-300 text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block  p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                <option value=""></option>
                <option value="1">1</option>
                <option value="2">2</option>
                <option value="3">3</option>
            ...
            <input 
                ...
                className="sm:block md:flex justify-items-center text-center mx-auto w-72 lg:w-full h-12 items-center bg-gray-50 border border-gray-300 text-gray-900 rounded-md focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                />
